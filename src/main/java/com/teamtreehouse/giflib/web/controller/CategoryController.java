...
public class CategoryController {
    ...
    public String formNewCategory(Model model) {
        ...
        model.addAttribute("submit", "Add New");
    ...
    public String formEditCategory(@PathVariable Long categoryId, Model model) {
        ...
        model.addAttribute("action", String.format("/categories/%s/edit",categoryId));
    ...
    public String updateCategory(RedirectAttributes redirectAttributes, @Valid Category category, BindingResult result) {
        if(result.hasErrors()){
